...
# ARG GRAVITY_ORCHESTRATOR_HASH=74c7107e41270cea2eaf797b0bd0f97d97ef7774dad8a9f3dcf862584372250a
WORKDIR /downloads/
...
ADD https://github.com/PeggyJV/gravity-bridge/releases/download/${GRAVITY_VERSION}/orchestrator .
# RUN echo "$GRAVITY_ORCHESTRATOR_HASH *orchestrator" | sha256sum -c -s
...
COPY --from=gravity-builder /downloads/orchestrator /usr/local/bin/
