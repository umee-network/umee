...
import (
	...
	types1 "github.com/umee-network/umee/v6/x/leverage/types"
	metoken "github.com/umee-network/umee/v6/x/metoken"
	types2 "github.com/umee-network/umee/v6/x/oracle/types"
)

// MockBankKeeper is a mock implementation of the BankKeeper interface (from
// the package github.com/umee-network/umee/v6/x/metoken) used for unit
// testing.
...
// interface (from the package github.com/umee-network/umee/v6/x/metoken)
...
type MockLeverageKeeper struct {
	...
	// ToTokenFunc is an instance of a mock function object controlling the
	// behavior of the method ToToken.
	ToTokenFunc *LeverageKeeperToTokenFunc
	// ToUTokenFunc is an instance of a mock function object controlling the
	// behavior of the method ToUToken.
	ToUTokenFunc *LeverageKeeperToUTokenFunc
	...
	return &MockLeverageKeeper{
		...
		ToTokenFunc: &LeverageKeeperToTokenFunc{
			defaultHook: func(types.Context, types.Coin) (types.Coin, error) {
				panic("unexpected invocation of MockLeverageKeeper.ToToken")
			},
		},
		ToUTokenFunc: &LeverageKeeperToUTokenFunc{
			defaultHook: func(types.Context, types.Coin) (types.Coin, error) {
				panic("unexpected invocation of MockLeverageKeeper.ToUToken")
			},
		},
		WithdrawToModuleFunc: &LeverageKeeperWithdrawToModuleFunc{
			defaultHook: func(types.Context, string, types.Coin) (types.Coin, bool, error) {
...
func NewMockLeverageKeeperFrom(i metoken.LeverageKeeper) *MockLeverageKeeper {
	return &MockLeverageKeeper{
		...
		ToTokenFunc: &LeverageKeeperToTokenFunc{
			defaultHook: i.ToToken,
		},
		ToUTokenFunc: &LeverageKeeperToUTokenFunc{
			defaultHook: i.ToUToken,
		},
		WithdrawToModuleFunc: &LeverageKeeperWithdrawToModuleFunc{
...
// LeverageKeeperToTokenFunc describes the behavior when the ToToken method
// of the parent MockLeverageKeeper instance is invoked.
type LeverageKeeperToTokenFunc struct {
	defaultHook func(types.Context, types.Coin) (types.Coin, error)
	hooks       []func(types.Context, types.Coin) (types.Coin, error)
	history     []LeverageKeeperToTokenFuncCall
	mutex       sync.Mutex
}

// ToToken delegates to the next hook function in the queue and stores the
// parameter and result values of this invocation.
func (m *MockLeverageKeeper) ToToken(v0 types.Context, v1 types.Coin) (types.Coin, error) {
	r0, r1 := m.ToTokenFunc.nextHook()(v0, v1)
	m.ToTokenFunc.appendCall(LeverageKeeperToTokenFuncCall{v0, v1, r0, r1})
	return r0, r1
}

// SetDefaultHook sets function that is called when the ToToken method of
// the parent MockLeverageKeeper instance is invoked and the hook queue is
// empty.
func (f *LeverageKeeperToTokenFunc) SetDefaultHook(hook func(types.Context, types.Coin) (types.Coin, error)) {
	f.defaultHook = hook
}

// PushHook adds a function to the end of hook queue. Each invocation of the
// ToToken method of the parent MockLeverageKeeper instance invokes the hook
// at the front of the queue and discards it. After the queue is empty, the
// default hook function is invoked for any future action.
func (f *LeverageKeeperToTokenFunc) PushHook(hook func(types.Context, types.Coin) (types.Coin, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefaultReturn calls SetDefaultHook with a function that returns the
// given values.
func (f *LeverageKeeperToTokenFunc) SetDefaultReturn(r0 types.Coin, r1 error) {
...
// PushReturn calls PushHook with a function that returns the given values.
func (f *LeverageKeeperToTokenFunc) PushReturn(r0 types.Coin, r1 error) {
	f.PushHook(func(types.Context, types.Coin) (types.Coin, error) {
		return r0, r1
	})
}

func (f *LeverageKeeperToTokenFunc) nextHook() func(types.Context, types.Coin) (types.Coin, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
func (f *LeverageKeeperToTokenFunc) appendCall(r0 LeverageKeeperToTokenFuncCall) {
	f.mutex.Lock()
	f.history = append(f.history, r0)
	f.mutex.Unlock()
}

// History returns a sequence of LeverageKeeperToTokenFuncCall objects
// describing the invocations of this function.
func (f *LeverageKeeperToTokenFunc) History() []LeverageKeeperToTokenFuncCall {
	f.mutex.Lock()
	history := make([]LeverageKeeperToTokenFuncCall, len(f.history))
	copy(history, f.history)
	f.mutex.Unlock()
...
// LeverageKeeperToTokenFuncCall is an object that describes an invocation
// of method ToToken on an instance of MockLeverageKeeper.
type LeverageKeeperToTokenFuncCall struct {
	// Arg0 is the value of the 1st argument passed to this method
	// invocation.
	Arg0 types.Context
	// Arg1 is the value of the 2nd argument passed to this method
...
// Args returns an interface slice containing the arguments of this
// invocation.
func (c LeverageKeeperToTokenFuncCall) Args() []interface{} {
	return []interface{}{c.Arg0, c.Arg1}
}

// Results returns an interface slice containing the results of this
// invocation.
func (c LeverageKeeperToTokenFuncCall) Results() []interface{} {
	return []interface{}{c.Result0, c.Result1}
}

// LeverageKeeperToUTokenFunc describes the behavior when the ToUToken
// method of the parent MockLeverageKeeper instance is invoked.
type LeverageKeeperToUTokenFunc struct {
	defaultHook func(types.Context, types.Coin) (types.Coin, error)
	hooks       []func(types.Context, types.Coin) (types.Coin, error)
...
// ToUToken delegates to the next hook function in the queue and stores the
// parameter and result values of this invocation.
func (m *MockLeverageKeeper) ToUToken(v0 types.Context, v1 types.Coin) (types.Coin, error) {
	r0, r1 := m.ToUTokenFunc.nextHook()(v0, v1)
	m.ToUTokenFunc.appendCall(LeverageKeeperToUTokenFuncCall{v0, v1, r0, r1})
	return r0, r1
}

// SetDefaultHook sets function that is called when the ToUToken method of
// the parent MockLeverageKeeper instance is invoked and the hook queue is
// empty.
func (f *LeverageKeeperToUTokenFunc) SetDefaultHook(hook func(types.Context, types.Coin) (types.Coin, error)) {
	f.defaultHook = hook
}

// PushHook adds a function to the end of hook queue. Each invocation of the
// ToUToken method of the parent MockLeverageKeeper instance invokes the
// hook at the front of the queue and discards it. After the queue is empty,
// the default hook function is invoked for any future action.
func (f *LeverageKeeperToUTokenFunc) PushHook(hook func(types.Context, types.Coin) (types.Coin, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefaultReturn calls SetDefaultHook with a function that returns the
// given values.
func (f *LeverageKeeperToUTokenFunc) SetDefaultReturn(r0 types.Coin, r1 error) {
	f.SetDefaultHook(func(types.Context, types.Coin) (types.Coin, error) {
		return r0, r1
	})
}
...
// PushReturn calls PushHook with a function that returns the given values.
func (f *LeverageKeeperToUTokenFunc) PushReturn(r0 types.Coin, r1 error) {
	f.PushHook(func(types.Context, types.Coin) (types.Coin, error) {
		return r0, r1
	})
}

func (f *LeverageKeeperToUTokenFunc) nextHook() func(types.Context, types.Coin) (types.Coin, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
func (f *LeverageKeeperToUTokenFunc) appendCall(r0 LeverageKeeperToUTokenFuncCall) {
	f.mutex.Lock()
	f.history = append(f.history, r0)
	f.mutex.Unlock()
}

// History returns a sequence of LeverageKeeperToUTokenFuncCall objects
// describing the invocations of this function.
func (f *LeverageKeeperToUTokenFunc) History() []LeverageKeeperToUTokenFuncCall {
	f.mutex.Lock()
	history := make([]LeverageKeeperToUTokenFuncCall, len(f.history))
	copy(history, f.history)
	f.mutex.Unlock()
...
// LeverageKeeperToUTokenFuncCall is an object that describes an invocation
// of method ToUToken on an instance of MockLeverageKeeper.
type LeverageKeeperToUTokenFuncCall struct {
	// Arg0 is the value of the 1st argument passed to this method
	// invocation.
	Arg0 types.Context
	// Arg1 is the value of the 2nd argument passed to this method
...
// Args returns an interface slice containing the arguments of this
// invocation.
func (c LeverageKeeperToUTokenFuncCall) Args() []interface{} {
	return []interface{}{c.Arg0, c.Arg1}
}

// Results returns an interface slice containing the results of this
// invocation.
func (c LeverageKeeperToUTokenFuncCall) Results() []interface{} {
	return []interface{}{c.Result0, c.Result1}
}
...
// (from the package github.com/umee-network/umee/v6/x/metoken) used for
// unit testing.
type MockOracleKeeper struct {
	...
	// SetExchangeRateWithEventFunc is an instance of a mock function object
	// controlling the behavior of the method SetExchangeRateWithEvent.
	SetExchangeRateWithEventFunc *OracleKeeperSetExchangeRateWithEventFunc
}
...
func NewMockOracleKeeper() *MockOracleKeeper {
	return &MockOracleKeeper{
		...
		SetExchangeRateWithEventFunc: &OracleKeeperSetExchangeRateWithEventFunc{
			defaultHook: func(types.Context, string, math.LegacyDec) {
				return
			},
		},
	}
...
func NewStrictMockOracleKeeper() *MockOracleKeeper {
	return &MockOracleKeeper{
		...
		SetExchangeRateWithEventFunc: &OracleKeeperSetExchangeRateWithEventFunc{
			defaultHook: func(types.Context, string, math.LegacyDec) {
				panic("unexpected invocation of MockOracleKeeper.SetExchangeRateWithEvent")
			},
		},
	}
}
...
func NewMockOracleKeeperFrom(i metoken.OracleKeeper) *MockOracleKeeper {
	return &MockOracleKeeper{
		...
		SetExchangeRateWithEventFunc: &OracleKeeperSetExchangeRateWithEventFunc{
			defaultHook: i.SetExchangeRateWithEvent,
		},
	}
}
...
// OracleKeeperSetExchangeRateWithEventFunc describes the behavior when the
// SetExchangeRateWithEvent method of the parent MockOracleKeeper instance
// is invoked.
type OracleKeeperSetExchangeRateWithEventFunc struct {
	defaultHook func(types.Context, string, math.LegacyDec)
	hooks       []func(types.Context, string, math.LegacyDec)
	history     []OracleKeeperSetExchangeRateWithEventFuncCall
	mutex       sync.Mutex
}

// SetExchangeRateWithEvent delegates to the next hook function in the queue
// and stores the parameter and result values of this invocation.
func (m *MockOracleKeeper) SetExchangeRateWithEvent(v0 types.Context, v1 string, v2 math.LegacyDec) {
	m.SetExchangeRateWithEventFunc.nextHook()(v0, v1, v2)
	m.SetExchangeRateWithEventFunc.appendCall(OracleKeeperSetExchangeRateWithEventFuncCall{v0, v1, v2})
	return
}
...
// SetExchangeRateWithEvent method of the parent MockOracleKeeper instance
// is invoked and the hook queue is empty.
func (f *OracleKeeperSetExchangeRateWithEventFunc) SetDefaultHook(hook func(types.Context, string, math.LegacyDec)) {
	f.defaultHook = hook
}
...
// queue is empty, the default hook function is invoked for any future
// action.
func (f *OracleKeeperSetExchangeRateWithEventFunc) PushHook(hook func(types.Context, string, math.LegacyDec)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefaultReturn calls SetDefaultHook with a function that returns the
// given values.
func (f *OracleKeeperSetExchangeRateWithEventFunc) SetDefaultReturn() {
	f.SetDefaultHook(func(types.Context, string, math.LegacyDec) {
		return
	})
}

// PushReturn calls PushHook with a function that returns the given values.
func (f *OracleKeeperSetExchangeRateWithEventFunc) PushReturn() {
	f.PushHook(func(types.Context, string, math.LegacyDec) {
		return
	})
}

func (f *OracleKeeperSetExchangeRateWithEventFunc) nextHook() func(types.Context, string, math.LegacyDec) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
func (f *OracleKeeperSetExchangeRateWithEventFunc) appendCall(r0 OracleKeeperSetExchangeRateWithEventFuncCall) {
	f.mutex.Lock()
	f.history = append(f.history, r0)
	f.mutex.Unlock()
}
...
// History returns a sequence of
// OracleKeeperSetExchangeRateWithEventFuncCall objects describing the
// invocations of this function.
func (f *OracleKeeperSetExchangeRateWithEventFunc) History() []OracleKeeperSetExchangeRateWithEventFuncCall {
	f.mutex.Lock()
	history := make([]OracleKeeperSetExchangeRateWithEventFuncCall, len(f.history))
	copy(history, f.history)
	f.mutex.Unlock()
...
// OracleKeeperSetExchangeRateWithEventFuncCall is an object that describes
// an invocation of method SetExchangeRateWithEvent on an instance of
// MockOracleKeeper.
type OracleKeeperSetExchangeRateWithEventFuncCall struct {
	// Arg0 is the value of the 1st argument passed to this method
	// invocation.
	Arg0 types.Context
	// Arg1 is the value of the 2nd argument passed to this method
...
// Args returns an interface slice containing the arguments of this
// invocation.
func (c OracleKeeperSetExchangeRateWithEventFuncCall) Args() []interface{} {
	return []interface{}{c.Arg0, c.Arg1, c.Arg2}
}

// Results returns an interface slice containing the results of this
// invocation.
func (c OracleKeeperSetExchangeRateWithEventFuncCall) Results() []interface{} {
	return []interface{}{}
}
