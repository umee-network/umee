...
type BorrowerSummaryNeat struct {
	...
	// Account Size is the sum of the USD value of all tokens the account has supplied, includng interest earned.
	AccountSize float64 `protobuf:"fixed64,2,opt,name=account_size,json=accountSize,proto3" json:"account_size,omitempty"`
	// C is collateral value as a portion of account size.
	C float64 `protobuf:"fixed64,3,opt,name=C,proto3" json:"C,omitempty"`
	// B is borrowed value as a portion of account size.
	B float64 `protobuf:"fixed64,4,opt,name=B,proto3" json:"B,omitempty"`
	// L is the borrow limit as a portion of account size.
	L float64 `protobuf:"fixed64,5,opt,name=L,proto3" json:"L,omitempty"`
	// Q is the liquidation threshold as a portion of account size.
	Q float64 `protobuf:"fixed64,6,opt,name=Q,proto3" json:"Q,omitempty"`
}
...
var fileDescriptor_e28247c0efa3108d = []byte{
	...
	,
}
...
func (this *BorrowerSummaryNeat) Equal(that interface{}) bool {
	...
	if this.AccountSize != that1.AccountSize {
		return false
	}
	if this.C != that1.C {
		return false
...
func (m *BorrowerSummaryNeat) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.C != 0 {
		i -= 8
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.C))))
		i--
		dAtA[i] = 0x19
	}
	if m.AccountSize != 0 {
		i -= 8
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.AccountSize))))
		i--
		dAtA[i] = 0x11
	}
	if len(m.Account) > 0 {
...
func (m *BorrowerSummaryNeat) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field AccountSize", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			iNdEx += 8
			m.AccountSize = float64(math.Float64frombits(v))
		case 3:
			if wireType != 1 {
