...
type QueryRiskDataResponse struct {
	Borrowers []AccountDecBalances `protobuf:"bytes,1,rep,name=borrowers,proto3" json:"borrowers"`
}
...
// AccountDecBalances contains an account's position denoted in symbol denom tokens.
type AccountDecBalances struct {
	Account string `protobuf:"bytes,1,opt,name=Account,proto3" json:"Account,omitempty"`
...
func (m *AccountDecBalances) Reset()         { *m = AccountDecBalances{} }
func (m *AccountDecBalances) String() string { return proto.CompactTextString(m) }
func (*AccountDecBalances) ProtoMessage()    {}
func (*AccountDecBalances) Descriptor() ([]byte, []int) {
	return fileDescriptor_e28247c0efa3108d, []int{8}
}
func (m *AccountDecBalances) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AccountDecBalances) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AccountDecBalances.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AccountDecBalances) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AccountDecBalances.Merge(m, src)
}
func (m *AccountDecBalances) XXX_Size() int {
	return m.Size()
}
func (m *AccountDecBalances) XXX_DiscardUnknown() {
	xxx_messageInfo_AccountDecBalances.DiscardUnknown(m)
}

var xxx_messageInfo_AccountDecBalances proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*AccountDecBalances)(nil), "umee.leverage.v1.AccountDecBalances")
}
...
var fileDescriptor_e28247c0efa3108d = []byte{
	...
	,
}
...
func (m *AccountDecBalances) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AccountDecBalances) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AccountDecBalances) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AccountDecBalances) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryRiskDataResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Borrowers = append(m.Borrowers, AccountDecBalances{})
			if err := m.Borrowers[len(m.Borrowers)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *AccountDecBalances) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AccountDecBalances: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AccountDecBalances: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
