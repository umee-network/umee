...
type EventFundAuction struct {
	Assets []types.Coin `protobuf:"bytes,1,rep,name=assets,proto3" json:"assets"`
}

func (m *EventFundAuction) Reset()         { *m = EventFundAuction{} }
func (m *EventFundAuction) String() string { return proto.CompactTextString(m) }
func (*EventFundAuction) ProtoMessage()    {}
func (*EventFundAuction) Descriptor() ([]byte, []int) {
	return fileDescriptor_aaf62b4902d7471c, []int{11}
}
func (m *EventFundAuction) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventFundAuction) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventFundAuction.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventFundAuction) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventFundAuction.Merge(m, src)
}
func (m *EventFundAuction) XXX_Size() int {
	return m.Size()
}
func (m *EventFundAuction) XXX_DiscardUnknown() {
	xxx_messageInfo_EventFundAuction.DiscardUnknown(m)
}

var xxx_messageInfo_EventFundAuction proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*EventFundAuction)(nil), "umee.leverage.v1.EventFundAuction")
}
...
var fileDescriptor_aaf62b4902d7471c = []byte{
	...
	,
}
...
func (m *EventFundAuction) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventFundAuction) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventFundAuction) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventFundAuction) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventFundAuction) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventFundAuction: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventFundAuction: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
