...
type Params struct {
	...
	// Valid values: 0-1.
	RewardsAuctionFee cosmossdk_io_math.LegacyDec `protobuf:"bytes,7,opt,name=rewards_auction_fee,json=rewardsAuctionFee,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"rewards_auction_fee" yaml:"rewards_auction_fee"`
}
...
type Token struct {
	...
	MaxSupply cosmossdk_io_math.Int `protobuf:"bytes,18,opt,name=max_supply,json=maxSupply,proto3,customtype=cosmossdk.io/math.Int" json:"max_supply" yaml:"max_supply"`
...
type SpecialAssetPair struct {
	...
	CollateralWeight cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=collateral_weight,json=collateralWeight,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"collateral_weight"`
...
type SpecialAssetSet struct {
	...
	// Valid values: 0-1.
	CollateralWeight cosmossdk_io_math.LegacyDec `protobuf:"bytes,2,opt,name=collateral_weight,json=collateralWeight,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"collateral_weight"`
	// Liquidation threshold defines what portion of the total value of the assets
	// can contribute to a users liquidation threshold, when borrowing within the set.
	// Valid values in range [collateral_weight,1]
	LiquidationThreshold cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=liquidation_threshold,json=liquidationThreshold,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"liquidation_threshold"`
}
...
var fileDescriptor_8cb1bf9ea641ecc6 = []byte{
	...
	,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if !this.CompleteLiquidationThreshold.Equal(that1.CompleteLiquidationThreshold) {
		return false
	}
	if !this.MinimumCloseFactor.Equal(that1.MinimumCloseFactor) {
		return false
	}
	if !this.OracleRewardFactor.Equal(that1.OracleRewardFactor) {
		return false
	}
	if !this.SmallLiquidationSize.Equal(that1.SmallLiquidationSize) {
		return false
	}
	if !this.DirectLiquidationFee.Equal(that1.DirectLiquidationFee) {
		return false
	}
	if !this.RewardsAuctionFee.Equal(that1.RewardsAuctionFee) {
		return false
	}
	return true
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.RewardsAuctionFee.Size()
		i -= size
		if _, err := m.RewardsAuctionFee.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RewardsAuctionFee", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.RewardsAuctionFee.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
