...
type Token struct {
	...
	// Maximum allowed collateral supply specifis how much of the token can
	// be provided in total as a collatera in the system.
	...
	MaxCollateralSupply uint32 `protobuf:"varint,15,opt,name=max_collateral_supply,json=maxCollateralSupply,proto3" json:"max_collateral_supply,omitempty" yaml:"small_liquidation_size"`
}
...
func (m *Token) GetMaxCollateralSupply() uint32 {
	if m != nil {
		return m.MaxCollateralSupply
	}
	return 0
}
...
var fileDescriptor_8cb1bf9ea641ecc6 = []byte{
	...
	,
}
...
func (this *Token) Equal(that interface{}) bool {
	...
	if this.MaxCollateralSupply != that1.MaxCollateralSupply {
		return false
	}
	return true
}
...
func (m *Token) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.MaxCollateralSupply != 0 {
		i = encodeVarintLeverage(dAtA, i, uint64(m.MaxCollateralSupply))
		i--
		dAtA[i] = 0x78
	}
	if m.Blacklist {
...
func (m *Token) Size() (n int) {
	...
	if m.MaxCollateralSupply != 0 {
		n += 1 + sovLeverage(uint64(m.MaxCollateralSupply))
	}
	return n
}
...
func (m *Token) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxCollateralSupply", wireType)
			}
			m.MaxCollateralSupply = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLeverage
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxCollateralSupply |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
