...
// for more details.
type Params struct {
	// Max Share Trigger specifies when token `max_collateral_share`, `max_supply`
	// parameters can take an action. When token supply or it's collateral value
	// is below `max_share_trigger`, the limitation is not checked.
	// Valule in USD. 1 = 1 USD
	// Valid values: 1-∞
	MaxShareTrigger uint64 `protobuf:"varint,1,opt,name=max_share_trigger,json=maxShareTrigger,proto3" json:"max_share_trigger,omitempty" yaml:"max_share_trigger"`
...
var fileDescriptor_8cb1bf9ea641ecc6 = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0x12
	if m.MaxShareTrigger != 0 {
		i = encodeVarintLeverage(dAtA, i, uint64(m.MaxShareTrigger))
		i--
		dAtA[i] = 0x8
	}
...
func (m *Params) Size() (n int) {
	...
	_ = l
	if m.MaxShareTrigger != 0 {
		n += 1 + sovLeverage(uint64(m.MaxShareTrigger))
	}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxShareTrigger", wireType)
			}
			m.MaxShareTrigger = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxShareTrigger |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
