...
type Params struct {
	...
	// Burn Auction Factor determines the portion of interest accrued on
	// borrows that is sent to the auction module for the rewards auction.
	// Valid values: 0-1.
	BurnAuctionFactor github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,7,opt,name=burn_auction_factor,json=burnAuctionFactor,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"burn_auction_factor" yaml:"oracle_reward_factor"`
}
...
var fileDescriptor_8cb1bf9ea641ecc6 = []byte{
	...
	,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if !this.BurnAuctionFactor.Equal(that1.BurnAuctionFactor) {
		return false
	}
	return true
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.BurnAuctionFactor.Size()
		i -= size
		if _, err := m.BurnAuctionFactor.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BurnAuctionFactor", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.BurnAuctionFactor.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
