...
type Token struct {
	...
	// Maximum collateral utilization allowed in the system as per cent. See
	// ADR-003 `collateral_utilization` definition for more details.
	// Valid values: 0-10000. 150 means 150%.
	// Expected value is between 100-400.
	MaxCollateralUtilization uint32 `protobuf:"varint,16,opt,name=max_collateral_utilization,json=maxCollateralUtilization,proto3" json:"max_collateral_utilization,omitempty" yaml:"max_collateral_utilization"`
}
...
var fileDescriptor_8cb1bf9ea641ecc6 = []byte{
	...
	,
}
...
func (this *Token) Equal(that interface{}) bool {
	...
	if this.MaxCollateralUtilization != that1.MaxCollateralUtilization {
		return false
	}
	return true
}
...
func (m *Token) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.MaxCollateralUtilization != 0 {
		i = encodeVarintLeverage(dAtA, i, uint64(m.MaxCollateralUtilization))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x80
...
func (m *Token) Size() (n int) {
	...
	if m.MaxCollateralUtilization != 0 {
		n += 2 + sovLeverage(uint64(m.MaxCollateralUtilization))
	}
	return n
}
...
func (m *Token) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxCollateralUtilization", wireType)
			}
			m.MaxCollateralUtilization = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLeverage
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxCollateralUtilization |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
