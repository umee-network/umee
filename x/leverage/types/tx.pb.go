...
// MsgFlashLiquidate is the request structure for the FlashLiquidate RPC.
type MsgFlashLiquidate struct {
	// Liquidator is the account address performing a liquidation and the signer
	// of the message.
	Liquidator string `protobuf:"bytes,1,opt,name=liquidator,proto3" json:"liquidator,omitempty"`
	// Borrower is the account whose borrow is being repaid, and collateral consumed,
...
func (m *MsgFlashLiquidate) Reset()         { *m = MsgFlashLiquidate{} }
func (m *MsgFlashLiquidate) String() string { return proto.CompactTextString(m) }
func (*MsgFlashLiquidate) ProtoMessage()    {}
func (*MsgFlashLiquidate) Descriptor() ([]byte, []int) {
	return fileDescriptor_72683128ee6e8843, []int{9}
}
func (m *MsgFlashLiquidate) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgFlashLiquidate) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgFlashLiquidate.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgFlashLiquidate) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgFlashLiquidate.Merge(m, src)
}
func (m *MsgFlashLiquidate) XXX_Size() int {
	return m.Size()
}
func (m *MsgFlashLiquidate) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgFlashLiquidate.DiscardUnknown(m)
}

var xxx_messageInfo_MsgFlashLiquidate proto.InternalMessageInfo

func (*MsgFlashLiquidate) XXX_MessageName() string {
	return "umee.leverage.v1.MsgFlashLiquidate"
}
...
// MsgFlashLiquidateResponse defines the Msg/FlashLiquidate response type.
type MsgFlashLiquidateResponse struct {
...
func (m *MsgFlashLiquidateResponse) Reset()         { *m = MsgFlashLiquidateResponse{} }
func (m *MsgFlashLiquidateResponse) String() string { return proto.CompactTextString(m) }
func (*MsgFlashLiquidateResponse) ProtoMessage()    {}
func (*MsgFlashLiquidateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_72683128ee6e8843, []int{20}
}
func (m *MsgFlashLiquidateResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgFlashLiquidateResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgFlashLiquidateResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgFlashLiquidateResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgFlashLiquidateResponse.Merge(m, src)
}
func (m *MsgFlashLiquidateResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgFlashLiquidateResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgFlashLiquidateResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgFlashLiquidateResponse proto.InternalMessageInfo

func (*MsgFlashLiquidateResponse) XXX_MessageName() string {
	return "umee.leverage.v1.MsgFlashLiquidateResponse"
}
...
func init() {
	...
	proto.RegisterType((*MsgFlashLiquidate)(nil), "umee.leverage.v1.MsgFlashLiquidate")
	...
	proto.RegisterType((*MsgFlashLiquidateResponse)(nil), "umee.leverage.v1.MsgFlashLiquidateResponse")
...
var fileDescriptor_72683128ee6e8843 = []byte{
	...
	,
}
...
func (c *msgClient) FlashLiquidate(ctx context.Context, in *MsgFlashLiquidate, opts ...grpc.CallOption) (*MsgFlashLiquidateResponse, error) {
	out := new(MsgFlashLiquidateResponse)
	err := c.cc.Invoke(ctx, "/umee.leverage.v1.Msg/FlashLiquidate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedMsgServer) FlashLiquidate(ctx context.Context, req *MsgFlashLiquidate) (*MsgFlashLiquidateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FlashLiquidate not implemented")
}
...
func _Msg_FlashLiquidate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgFlashLiquidate)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).FlashLiquidate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/umee.leverage.v1.Msg/FlashLiquidate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).FlashLiquidate(ctx, req.(*MsgFlashLiquidate))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FlashLiquidate",
			Handler:    _Msg_FlashLiquidate_Handler,
		},
		{
...
func (m *MsgFlashLiquidate) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgFlashLiquidate) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgFlashLiquidate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgFlashLiquidateResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgFlashLiquidateResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgFlashLiquidateResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgFlashLiquidate) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgFlashLiquidateResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgFlashLiquidate) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgFlashLiquidate: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgFlashLiquidate: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MsgFlashLiquidateResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgFlashLiquidateResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgFlashLiquidateResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
