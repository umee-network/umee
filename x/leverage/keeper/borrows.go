...
// CalculateMaxBorrow uses the price oracle to determine the maximum borrow (in USD) before a
...
// calculation fails.
func (k Keeper) CalculateMaxBorrow(ctx sdk.Context, collateral sdk.Coins) (sdk.Dec, error) {
