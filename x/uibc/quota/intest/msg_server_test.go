	...
	tests := []struct {
	...
	}{
		{
			...
			msg: uibc.MsgGovUpdateQuota{
				...
				PerDenom:                    sdkmath.LegacyNewDec(1000),
				Total:                       sdkmath.LegacyNewDec(10000),
				InflowOutflowQuotaBase:      sdkmath.LegacyNewDec(200),
		...
		},
		{
			...
			msg: uibc.MsgGovUpdateQuota{
				...
				QuotaDuration:               time.Duration(time.Minute * 100),
				PerDenom:                    sdkmath.LegacyNewDec(1000),
				Total:                       sdkmath.LegacyNewDec(100),
				InflowOutflowQuotaBase:      sdkmath.LegacyNewDec(200),
				InflowOutflowTokenQuotaBase: sdkmath.LegacyNewDec(200),
				InflowOutflowQuotaRate:      sdkmath.LegacyNewDecWithPrec(1, 1),
			},
		...
		},
		{
			...
			msg: uibc.MsgGovUpdateQuota{
				...
				PerDenom:                    sdkmath.LegacyNewDec(10000),
				Total:                       sdkmath.LegacyNewDec(100000),
				InflowOutflowQuotaBase:      sdkmath.LegacyNewDec(200),
				InflowOutflowTokenQuotaBase: sdkmath.LegacyNewDec(200),
				InflowOutflowQuotaRate:      sdkmath.LegacyNewDecWithPrec(1, 1),
			},
