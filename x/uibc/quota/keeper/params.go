...
// SetIBCTransferQuotaStatus update the ibc-transfer quota status in module params.
func (k Keeper) SetIBCTransferQuotaStatus(ibcStatus uibc.IBCTransferQuotaStatus) error {
	params := k.GetParams()
	params.QuotaStatus = ibcStatus
