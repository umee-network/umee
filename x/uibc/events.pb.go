...
func (m *EventQuotaPause) Reset()         { *m = EventQuotaPause{} }
func (m *EventQuotaPause) String() string { return proto.CompactTextString(m) }
func (*EventQuotaPause) ProtoMessage()    {}
func (*EventQuotaPause) Descriptor() ([]byte, []int) {
	return fileDescriptor_c64e60b79cebf048, []int{1}
}
func (m *EventQuotaPause) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventQuotaPause) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventQuotaPause.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventQuotaPause) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventQuotaPause.Merge(m, src)
}
func (m *EventQuotaPause) XXX_Size() int {
	return m.Size()
}
func (m *EventQuotaPause) XXX_DiscardUnknown() {
	xxx_messageInfo_EventQuotaPause.DiscardUnknown(m)
}

var xxx_messageInfo_EventQuotaPause proto.InternalMessageInfo

func init() {
	proto.RegisterType((*EventBadRevert)(nil), "umee.uibc.v1.EventBadRevert")
	proto.RegisterType((*EventQuotaPause)(nil), "umee.uibc.v1.EventQuotaPause")
}
...
var fileDescriptor_c64e60b79cebf048 = []byte{
	...
	0xa2, 0xd4, 0xf8, 0x92, 0xca, 0x82, 0x54, 0x09, 0x26, 0x05, 0x46, 0x0d, 0xce, 0x20, 0x6e, 0xa8,
	0x58, 0x48, 0x65, 0x41, 0xaa, 0x90, 0x18, 0x17, 0x5b, 0x41, 0x62, 0x72, 0x76, 0x6a, 0x89, 0x04,
	0x33, 0x58, 0x12, 0xca, 0x53, 0xf2, 0xe2, 0xe2, 0x07, 0x1b, 0x16, 0x08, 0xb2, 0x20, 0x20, 0xb1,
	0xb4, 0x38, 0x55, 0xc8, 0x9c, 0x8b, 0xad, 0xb8, 0x24, 0xb1, 0xa4, 0xb4, 0x58, 0x82, 0x51, 0x81,
	0x51, 0x83, 0xcf, 0x48, 0x5e, 0x0f, 0xd9, 0xb9, 0x7a, 0x9e, 0x4e, 0xce, 0x21, 0x45, 0x89, 0x79,
	0xc5, 0x69, 0xa9, 0x45, 0xc1, 0x60, 0x65, 0x41, 0x50, 0xe5, 0x4e, 0x2e, 0x27, 0x1e, 0xca, 0x31,
	...
	0x69, 0x92, 0x5e, 0x72, 0x7e, 0xae, 0x3e, 0xc8, 0x40, 0xdd, 0xbc, 0xd4, 0x92, 0xf2, 0xfc, 0xa2,
	0x6c, 0x30, 0x47, 0xbf, 0xcc, 0x44, 0xbf, 0x02, 0xec, 0xdb, 0x24, 0x36, 0xb0, 0x2f, 0x8d, 0x01,
	0x01, 0x00, 0x00, 0xff, 0xff, 0x01, 0x22, 0xbc, 0xa1, 0x40, 0x01, 0x00, 0x00,
}
...
func (m *EventQuotaPause) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventQuotaPause) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventQuotaPause) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventQuotaPause) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventQuotaPause) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventQuotaPause: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventQuotaPause: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
