...
// GetQueryCmd returns the CLI query commands for the x/refileverage module.
...
// GetCmdQueryParams creates a Cobra command to query for the x/refileverage
// module parameters.
func GetCmdQueryParams() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "params",
		Args:  cobra.NoArgs,
		Short: "Query the x/refileverage module parameters",
...
// the registered tokens in the x/refileverage module.
