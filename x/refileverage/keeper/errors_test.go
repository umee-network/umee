...
func TestErrorMatching(t *testing.T) {
	...
	err3 := refileveragetypes.ErrNoHistoricMedians.Wrapf(
		"requested %d, got %d",
		16,
		12,
	)
	// not oracle errors
	err4 := refileveragetypes.ErrBlacklisted
	err5 := refileveragetypes.ErrUToken
	err6 := refileveragetypes.ErrNotRegisteredToken
