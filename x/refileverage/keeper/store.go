...
// x/refileverage module account currently holds as collateral for a given borrower.
...
// setCollateral sets the amount of a given denom the x/refileverage module account
