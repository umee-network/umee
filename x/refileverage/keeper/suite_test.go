...
import (
	...
	"github.com/umee-network/umee/v5/x/refileverage/fixtures"
...
func (s *IntegrationTestSuite) SetupTest() {
	...
	refileverage.InitGenesis(ctx, app.LeverageKeeper, *types.DefaultGenesis())
...
// supply tokens from an account and require no errors. Use when setting up refileverage scenarios.
...
// withdraw utokens from an account and require no errors. Use when setting up refileverage scenarios.
...
// collateralize uTokens from an account and require no errors. Use when setting up refileverage scenarios.
...
// decollateralize uTokens from an account and require no errors. Use when setting up refileverage scenarios.
...
// borrow tokens as an account and require no errors. Use when setting up refileverage scenarios.
