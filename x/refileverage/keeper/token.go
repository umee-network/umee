...
// CleanTokenRegistry deletes all blacklisted tokens in the refileverage registry
...
// deleteTokenSettings deletes a Token in the x/refileverage module's KVStore.
...
// SetTokenSettings stores a Token into the x/refileverage module's KVStore.
...
// GetTokenSettings gets a token from the x/refileverage module's KVStore.
