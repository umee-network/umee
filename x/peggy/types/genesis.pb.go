...
type Params struct {
	...
	Erc20Mapping                  []ERC20ToDenom                         `protobuf:"bytes,20,rep,name=erc20_mapping,json=erc20Mapping,proto3" json:"erc20_mapping"`
}
...
func (m *Params) GetErc20Mapping() []ERC20ToDenom {
	if m != nil {
		return m.Erc20Mapping
	}
	return nil
}
...
var fileDescriptor_3a3891bc0dfe5831 = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.Erc20Mapping) > 0 {
		for iNdEx := len(m.Erc20Mapping) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Erc20Mapping[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Erc20Mapping", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Erc20Mapping = append(m.Erc20Mapping, ERC20ToDenom{})
			if err := m.Erc20Mapping[len(m.Erc20Mapping)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
