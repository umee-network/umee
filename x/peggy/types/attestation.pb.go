...
func init() {
	proto.RegisterEnum("umeenetwork.umee.peggy.v1.ClaimType", ClaimType_name, ClaimType_value)
	proto.RegisterType((*Attestation)(nil), "umeenetwork.umee.peggy.v1.Attestation")
	proto.RegisterType((*ERC20Token)(nil), "umeenetwork.umee.peggy.v1.ERC20Token")
}

func init() { proto.RegisterFile("umee/peggy/v1/attestation.proto", fileDescriptor_f3f45eb20993635f) }
