...
func TestValsetConfirmHash(t *testing.T) {
	...
	v := NewValset(0, 0, members, sdk.NewInt(0), common.Address{})
	...
	correctHash := "0xaca2f283f21a03ba182dc7d34a55c04771b25087401d680011df7dcba453f798"
	assert.Equal(t, correctHash, hash.Hex())
}
...
func TestValsetCheckpointGold1(t *testing.T) {
	...
	goldHash := "0x89731c26bab12cf0cb5363ef9abab6f9bd5496cf758a2309311c7946d54bca85"
	assert.Equal(t, goldHash, ourHash.Hex())
}
