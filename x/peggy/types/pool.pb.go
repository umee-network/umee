...
func init() {
	proto.RegisterType((*IDSet)(nil), "umeenetwork.umee.peggy.v1.IDSet")
	proto.RegisterType((*BatchFees)(nil), "umeenetwork.umee.peggy.v1.BatchFees")
}

func init() { proto.RegisterFile("umee/peggy/v1/pool.proto", fileDescriptor_498548dd08ebbc8d) }
