...
var (
	...
	ErrNotImplemented          = sdkerrors.Register(ModuleName, 17, "function not implemented")
	...
	ErrMalformedLatestAvgPrice = sdkerrors.Register(ModuleName, 21, "malformed latest avg price, expecting one byte")
	ErrNoLatestAvgPrice        = sdkerrors.Register(ModuleName, 22, "no latest average price")
)
