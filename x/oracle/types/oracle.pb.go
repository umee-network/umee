...
type Params struct {
	...
	// avg_period
	AvgPeriod time.Duration `protobuf:"bytes,13,opt,name=avg_period,json=avgPeriod,proto3,stdduration" json:"avg_period,omitempty" yaml:"avg_period"`
	// avg shift
	AvgShift time.Duration `protobuf:"bytes,14,opt,name=avg_shift,json=avgShift,proto3,stdduration" json:"avg_shift,omitempty" yaml:"avg_shift"`
}
...
var fileDescriptor_8893c9e0e94ceb54 = []byte{
	...
	,
}
