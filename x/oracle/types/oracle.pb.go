...
type Params struct {
	...
	HistoricAcceptList DenomList `protobuf:"bytes,9,rep,name=historic_accept_list,json=historicAcceptList,proto3,castrepeated=DenomList" json:"historic_accept_list" yaml:"historic_accept_list"`
	// Stamp Period represents the amount of blocks the historacle module
	// waits before recording a set of prices from the oracle.
	StampPeriod uint64 `protobuf:"varint,10,opt,name=stamp_period,json=stampPeriod,proto3" json:"stamp_period,omitempty"`
	// Prune Period represents the maximum amount of blocks which we want
	// to keep a record of our set of exchange rates.
	PrunePeriod uint64 `protobuf:"varint,11,opt,name=prune_period,json=prunePeriod,proto3" json:"prune_period,omitempty"`
	...
	MedianPeriod uint64 `protobuf:"varint,12,opt,name=median_period,json=medianPeriod,proto3" json:"median_period,omitempty"`
}
...
var fileDescriptor_8893c9e0e94ceb54 = []byte{
	...
	,
}
