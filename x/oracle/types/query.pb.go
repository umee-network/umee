...
type QueryAvgPrice struct {
	...
	//	*QueryAvgPrice_Denom
	XDenom isQueryAvgPrice_XDenom `protobuf_oneof:"_denom"`
}
...
type isQueryAvgPrice_XDenom interface {
	isQueryAvgPrice_XDenom()
	MarshalTo([]byte) (int, error)
	Size() int
}

type QueryAvgPrice_Denom struct {
	Denom string `protobuf:"bytes,1,opt,name=denom,proto3,oneof" json:"denom,omitempty"`
}

func (*QueryAvgPrice_Denom) isQueryAvgPrice_XDenom() {}

func (m *QueryAvgPrice) GetXDenom() isQueryAvgPrice_XDenom {
	if m != nil {
		return m.XDenom
	}
	return nil
...
func (m *QueryAvgPrice) GetDenom() string {
	if x, ok := m.GetXDenom().(*QueryAvgPrice_Denom); ok {
		return x.Denom
	}
	return ""
}
...
func (*QueryAvgPrice) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*QueryAvgPrice_Denom)(nil),
	}
}
...
var fileDescriptor_710e319bc1815d33 = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	// QueryAvgPrice returns avg price of a given denom
...
func (m *QueryAvgPrice_Denom) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryAvgPrice_Denom) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.Denom)
	copy(dAtA[i:], m.Denom)
	i = encodeVarintQuery(dAtA, i, uint64(len(m.Denom)))
...
func (m *QueryAvgPrice_Denom) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryAvgPrice) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.XDenom = &QueryAvgPrice_Denom{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])
