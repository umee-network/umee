...
A `SlashWindow` is a window of time during which validators can miss votes. At the end of every period, the amount of misses are tallied and the proper reward or punishment is carried out.
