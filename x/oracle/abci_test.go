...
func TestOracleThreshold(t *testing.T) {
	input, h := setup(t)
	exchangeRateStr := randomExchangeRate.String() + types.MicroSDRDenom
...
func TestOracleDrop(t *testing.T) {
	...
	// Account 1, KRW
	makeAggregatePrevoteAndVote(t, input, h, 0, sdk.DecCoins{{Denom: types.MicroKRWDenom, Amount: randomExchangeRate}}, 0)
...
func TestOracleTally(t *testing.T) {
	...
	for i, rate := range rates {
		...
		exchangeRateStr := decExchangeRate.String() + types.MicroSDRDenom
		...
		vote := types.NewVoteForTally(
			decExchangeRate, types.MicroSDRDenom, valAddrs[i], power)
...
func TestOracleTallyTiming(t *testing.T) {
	...
	for i := range keeper.Addrs[:2] {
		makeAggregatePrevoteAndVote(t, input, h, 0, sdk.DecCoins{{Denom: types.MicroSDRDenom, Amount: randomExchangeRate}}, i)
	}
...
func TestOracleRewardDistribution(t *testing.T) {
	...
	// Account 1, SDR
	makeAggregatePrevoteAndVote(t, input, h, 0, sdk.DecCoins{{Denom: types.MicroSDRDenom, Amount: randomExchangeRate}}, 0)

	// Account 2, SDR
	makeAggregatePrevoteAndVote(t, input, h, 0, sdk.DecCoins{{Denom: types.MicroSDRDenom, Amount: randomExchangeRate}}, 1)

	rewardsAmt := sdk.NewInt(100000000)
	err := input.BankKeeper.MintCoins(input.Ctx, types.ModuleName, sdk.NewCoins(sdk.NewCoin(types.MicroLunaDenom, rewardsAmt)))
	require.NoError(t, err)
...
func TestOracleRewardBand(t *testing.T) {
	...
	// Account 1, KRW
	makeAggregatePrevoteAndVote(t, input, h, 0, sdk.DecCoins{{Denom: types.MicroKRWDenom, Amount: randomExchangeRate.Sub(rewardSpread)}}, 0)

	// Account 2, KRW
	makeAggregatePrevoteAndVote(t, input, h, 0, sdk.DecCoins{{Denom: types.MicroKRWDenom, Amount: randomExchangeRate}}, 1)

	// Account 3, KRW
	makeAggregatePrevoteAndVote(t, input, h, 0, sdk.DecCoins{{Denom: types.MicroKRWDenom, Amount: randomExchangeRate.Add(rewardSpread)}}, 2)
	...
	// Account 1, KRW
	makeAggregatePrevoteAndVote(t, input, h, 0, sdk.DecCoins{{Denom: types.MicroKRWDenom, Amount: randomExchangeRate.Sub(rewardSpread.Add(sdk.OneDec()))}}, 0)
...
func TestOracleMultiRewardDistribution(t *testing.T) {
	...
	// Account 1, SDR, KRW
	makeAggregatePrevoteAndVote(t, input, h, 0, sdk.DecCoins{{Denom: types.MicroSDRDenom, Amount: randomExchangeRate}, {Denom: types.MicroKRWDenom, Amount: randomExchangeRate}}, 0)

	// Account 2, SDR
	makeAggregatePrevoteAndVote(t, input, h, 0, sdk.DecCoins{{Denom: types.MicroSDRDenom, Amount: randomExchangeRate}}, 1)

	// Account 3, KRW
	makeAggregatePrevoteAndVote(t, input, h, 0, sdk.DecCoins{{Denom: types.MicroKRWDenom, Amount: randomExchangeRate}}, 2)

	rewardAmt := sdk.NewInt(100000000)
	err := input.BankKeeper.MintCoins(input.Ctx, types.ModuleName, sdk.NewCoins(sdk.NewCoin(types.MicroLunaDenom, rewardAmt)))
	require.NoError(t, err)
...
func TestOracleExchangeRate(t *testing.T) {
	...
	// Account 1, USD, KRW
	makeAggregatePrevoteAndVote(t, input, h, 0, sdk.DecCoins{{Denom: types.MicroUSDDenom, Amount: uswRandomExchangeRate}, {Denom: types.MicroKRWDenom, Amount: krwRandomExchangeRate}}, 0)

	// Account 2, USD, KRW
	makeAggregatePrevoteAndVote(t, input, h, 0, sdk.DecCoins{{Denom: types.MicroUSDDenom, Amount: uswRandomExchangeRate}, {Denom: types.MicroKRWDenom, Amount: krwRandomExchangeRate}}, 1)

	// Account 3, KRW, SDR
	makeAggregatePrevoteAndVote(t, input, h, 0, sdk.DecCoins{{Denom: types.MicroKRWDenom, Amount: krwRandomExchangeRate}, {Denom: types.MicroSDRDenom, Amount: randomExchangeRate}}, 2)
...
func TestOracleExchangeRateVal5(t *testing.T) {
	...
	// KRW has been chosen as referenceTerra by highest voting power
	// Account 1, KRW, USD
	makeAggregatePrevoteAndVote(t, input, h, 0, sdk.DecCoins{{Denom: types.MicroKRWDenom, Amount: krwExchangeRate}, {Denom: types.MicroUSDDenom, Amount: usdExchangeRate}}, 0)

	// Account 2, KRW
	makeAggregatePrevoteAndVote(t, input, h, 0, sdk.DecCoins{{Denom: types.MicroKRWDenom, Amount: krwExchangeRate}}, 1)

	// Account 3, KRW
	makeAggregatePrevoteAndVote(t, input, h, 0, sdk.DecCoins{{Denom: types.MicroKRWDenom, Amount: krwExchangeRate}}, 2)

	// Account 4, KRW, USD
	makeAggregatePrevoteAndVote(t, input, h, 0, sdk.DecCoins{{Denom: types.MicroKRWDenom, Amount: krwExchangeRateWithErr}, {Denom: types.MicroUSDDenom, Amount: usdExchangeRateWithErr}}, 3)

	// Account 5, KRW, USD
	makeAggregatePrevoteAndVote(t, input, h, 0, sdk.DecCoins{{Denom: types.MicroKRWDenom, Amount: krwExchangeRateWithErr}, {Denom: types.MicroUSDDenom, Amount: usdExchangeRateWithErr}}, 4)
...
func TestInvalidVotesSlashing(t *testing.T) {
	...
	for i := uint64(0); i < uint64(sdk.OneDec().Sub(minValidPerWindow).MulInt64(votePeriodsPerWindow).TruncateInt64()); i++ {
		...
		makeAggregatePrevoteAndVote(t, input, h, 0, sdk.DecCoins{{Denom: types.MicroKRWDenom, Amount: randomExchangeRate.Add(sdk.NewDec(100000000000000))}}, 1)
...
func TestAbstainSlashing(t *testing.T) {
	...
	for i := uint64(0); i <= uint64(sdk.OneDec().Sub(minValidPerWindow).MulInt64(votePeriodsPerWindow).TruncateInt64()); i++ {
		...
		makeAggregatePrevoteAndVote(t, input, h, 0, sdk.DecCoins{{Denom: types.MicroKRWDenom, Amount: sdk.ZeroDec()}}, 1)
...
func TestAbstainWithSmallStakingPower(t *testing.T) {
	...
	input.OracleKeeper.ClearTobinTaxes(input.Ctx)
	input.OracleKeeper.SetTobinTax(input.Ctx, types.MicroKRWDenom, types.DefaultTobinTax)
	makeAggregatePrevoteAndVote(t, input, h, 0, sdk.DecCoins{{Denom: types.MicroKRWDenom, Amount: sdk.ZeroDec()}}, 0)
