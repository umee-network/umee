...
func TestValidateStructs(t *testing.T) {
	...
	invalidUnbonding = validUnbonding
	invalidUnbonding.UToken = sdk.Coin{Denom: coin.U_umee, Amount: sdkmath.NewInt(-1)}
	...
	invalidAccountUnbondings = validAccountUnbondings
	invalidAccountUnbondings.Unbondings[0].UToken = sdk.Coin{Denom: coin.U_umee, Amount: sdkmath.NewInt(-1)}
