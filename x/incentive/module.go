...
import (
	...
	"github.com/umee-network/umee/v2/x/incentive/client/cli"
...
func NewAppModule(cdc codec.Codec, keeper keeper.Keeper, ak types.AccountKeeper, bk types.BankKeeper, lk types.LeverageKeeper) AppModule {
	return AppModule{
