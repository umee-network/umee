...
// UToken2TokenRate implements the expected leverage keeper, with uToken exchange rates always equal to 1
func (m *mockLeverageKeeper) UToken2TokenRate(_ sdk.Context, uToken sdk.Coin) (sdk.Coin, error) {
