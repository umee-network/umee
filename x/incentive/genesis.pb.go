...
type GenesisState struct {
	...
	TotalUnbonding     []TotalBond         `protobuf:"bytes,8,rep,name=total_unbonding,json=totalUnbonding,proto3" json:"total_unbonding"`
	...
	AccountUnbondings  []AccountUnbondings `protobuf:"bytes,12,rep,name=account_unbondings,json=accountUnbondings,proto3" json:"account_unbondings"`
}
...
func (m *GenesisState) GetTotalUnbonding() []TotalBond {
	if m != nil {
		return m.TotalUnbonding
	}
	return nil
}
...
// TotalBond tracks the amount of coins of one uToken denomination bonded to, or unbonding from,
// a given reward tier by all accounts.
...
// for a given bond denom and tier.
...
var fileDescriptor_3f117566517b8062 = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TotalUnbonding) > 0 {
		for iNdEx := len(m.TotalUnbonding) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.TotalUnbonding[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *GenesisState) Size() (n int) {
	...
	if len(m.TotalUnbonding) > 0 {
		for _, e := range m.TotalUnbonding {
			l = e.Size()
			n += 1 + l + sovGenesis(uint64(l))
		}
	}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalUnbonding", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TotalUnbonding = append(m.TotalUnbonding, TotalBond{})
			if err := m.TotalUnbonding[len(m.TotalUnbonding)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 9:
