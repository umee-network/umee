...
func (k Keeper) InitGenesis(gs *ugov.GenesisState) error {
	...
	if err := k.SetLiquidationParams(gs.LiquidationParams); err != nil {
		return err
	}

	return k.SetInflationCycleStartTime(gs.InflationCycleStartTime)
}
