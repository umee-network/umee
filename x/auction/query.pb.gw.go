...
func request_Query_RewardsParams_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq QueryRewardsParams
	var metadata runtime.ServerMetadata

	msg, err := client.RewardsParams(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_Query_RewardsParams_0(ctx context.Context, marshaler runtime.Marshaler, server QueryServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq QueryRewardsParams
	var metadata runtime.ServerMetadata

	msg, err := server.RewardsParams(ctx, &protoReq)
	return msg, metadata, err
...
func request_Query_RewardsAuction_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq QueryRewardsAuction
	var metadata runtime.ServerMetadata
...
func request_Query_RewardsAuctions_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq QueryRewardsAuctions
	var metadata runtime.ServerMetadata
...
func RegisterQueryHandlerServer(ctx context.Context, mux *runtime.ServeMux, server QueryServer) error {
	...
	mux.Handle("GET", pattern_Query_RewardsParams_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Query_RewardsParams_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Query_RewardsParams_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterQueryHandlerClient(ctx context.Context, mux *runtime.ServeMux, client QueryClient) error {
	...
	mux.Handle("GET", pattern_Query_RewardsParams_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Query_RewardsParams_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Query_RewardsParams_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"umee", "auction", "v1", "rewards", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_RewardsAuction_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"umee", "auction", "v1", "rewards", "id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_RewardsAuctions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"umee", "auction", "v1", "rewards"}, "", runtime.AssumeColonVerbOpt(false)))
)

var (
	forward_Query_RewardsParams_0 = runtime.ForwardResponseMessage
