...
func New(
	...
	//// TODO: https://github.com/umee-network/umee/issues/1413
	...
	// can do so safely.
	app.mm.SetOrderInitGenesis(moduleOrder...)
	app.mm.SetOrderMigrations(moduleOrder...)
