...
func RegisterUpgradeHandlers(
	...
	leverageKeeper *leveragekeeper.Keeper, incentiveKeeper *incentivekeeper.Keeper, oracleKeeper *oraclekeeper.Keeper,
) {
	...
	upgradeKeeper.SetUpgradeHandler(
		...
		calypso.GetCalypsoUpgradeHandler(
			...
			distrKeeper, mintKeeper, stakingKeeper, leverageKeeper, incentiveKeeper, oracleKeeper,
		),
	)
}
