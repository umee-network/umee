...
# Haven't seen the following line in any example but without it the building fails with:
# go build: cannot write multiple packages to non-directory /tmp/tmp.4B19yXURcw/buildsources/build/
mkdir -p ${pristinesrcdir}/build
