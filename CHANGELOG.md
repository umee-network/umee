...
- [2180](https://github.com/umee-network/umee/pull/2180) Rename leverage `Kepeer.ExchangeToken -> Token2uTokenRate`, `Kepeer.ExchangeUToken -> UToken2TokenRate` and `Kepeer.ExchangeTokens -> Tokens2uTokensRate`.
