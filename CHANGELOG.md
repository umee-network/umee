...
- [XXXX](https://github.com/umee-network/umee/pull/XXXX) Add leverage parameter DirectLiquidationFee
...
- [XXXX](https://github.com/umee-network/umee/pull/XXXX) Liquidation reward_denom can now be either token or uToken
