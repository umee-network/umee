...
require (
	...
	github.com/cosmos/gogoproto v1.4.12 // NOTE: v1.4.11+ is not compatible with sdk v0.47
	...
	golang.org/x/exp v0.0.0-20231006140011-7918f672742d // must be v0.0.0-20230711153332-06a737ee72cb for gogoproto v1.4.10
